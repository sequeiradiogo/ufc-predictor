...
|----------|----------|---------------|
| `weekly-predictions.yml` | Fridays 12:00 UTC | Downloads DB artifacts + `raw_data/rankings_history.csv`, runs `scripts/predict_event.py --model ensemble --skip-existing`, commits new `predictions/*.md` |
